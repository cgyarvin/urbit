                        ...
                        u2_noun gen)                              //  retain
  {
    ...
    if ( u2_no == u2_dust(gen) ) {
      ...
      _mint_used(wir_r);
      {
        ...
        u2_noun tom = u2_bc(wir_r, c3__bone, u2_blip);
        u2_noun bor = j2_mcy(Pt6, ut, cull)(wir_r, van, sut, axe, tom);
      ...
      _mint_used(wir_r);
      {
        ...
        if ( u2_no == fab ) {
          ret = u2_bc
            (wir_r, u2_bc(wir_r, c3__bone, u2_blip), u2_bc(wir_r, _0, _0));
        } else {
          ret = u2_bc
            (wir_r, 
             u2_bc(wir_r, c3__bone, u2_blip),
      ...
      _mint_used(wir_r);
      {
        u2_noun hos = 
          u2_bt(wir_r, 
                c3__bnpd,
                u2_bt(wir_r, c3__ktbn, 'a', u2_rx(wir_r, p_gen)),
                u2_bt(wir_r, 
                      c3__bnpd,
                      u2_bt(wir_r, c3__ktbn, 'b', 
                                   u2_bt(wir_r, c3__bnld,
                                                u2_bc(wir_r, _0, _2),
                                                u2_rx(wir_r, q_gen))),
                      u2_bt(wir_r, 
                            c3__csld,
                            u2_bq(wir_r, c3__mtdp, 'a', 'b', u2_nul),
                            'b')));
        u2_noun ryd = j2_mcx(Pt6, ut, mint)(wir_r, van, sut, c3__noun, hos);
        u2_noun viz = j2_mcy(Pt6, ut, play)(wir_r, van, sut, p_gen);
        u2_noun fin = j2_mby(Pt6, fine)(wir_r, c3__very, viz, u2_h(ryd));
        u2_noun ret = u2_bc
          (wir_r, _mint_nice(wir_r, van, gol, fin), u2_rx(wir_r, u2_t(ryd)));
