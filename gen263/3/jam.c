...
*/
               ...
               u2_noun l)                                         //  retain
  {
    ...
    u2_noun x = j2_mbc(Pit, add)(wir_r, _2, b);
    ...
    {
      u2_noun y = j2_mbc(Pit, add)(wir_r, x, p_d);
      u2_noun e = _jam_in(wir_r, t_a, y, r_d, q_d);
      u2_noun p_e, q_e, r_e;

      u2_as_trel(e, &p_e, &q_e, &r_e);
      {
        u2_noun z = j2_mbc(Pit, add)(wir_r, p_d, p_e);

        r = u2_bt
          (wir_r, j2_mbc(Pit, add)(wir_r, _2, z),
                  u2_rx(wir_r, q_e),
                  u2_rx(wir_r, r_e));
  ...
  _jam_in_flat(u2_wire wir_r,
               ...
               u2_noun l)                                         //  retain
  {
    u2_noun d = j2_mby(Pit, mat)(wir_r, a);
    u2_noun x = j2_mbc(Pit, add)(wir_r, _1, u2_h(d));
    u2_noun y = u2_bt
      (wir_r, u2_rx(wir_r, x),
              u2_bc(wir_r, u2_bc(wir_r, 
                                 x,
                                 j2_mbc(Pit, lsh)(wir_r, _0, _1, u2_t(d))),
                           u2_rx(wir_r, l)),
              u2_rx(wir_r, m));
  ...
  _jam_in_ptr(u2_wire wir_r,
              ...
              u2_noun l)                                          //  retain
  {
    u2_noun d = j2_mby(Pit, mat)(wir_r, u_c);
    u2_atom x = j2_mbc(Pit, lsh)(wir_r, _0, _2, u2_t(d));
    u2_atom y = j2_mbc(Pit, add)(wir_r, _2, u2_h(d));
    u2_noun z = u2_bt
      (wir_r, u2_rx(wir_r, y),
              u2_bc(wir_r, u2_bc(wir_r, y, j2_mbc(Pit, mix)(wir_r, _3, x)),
                           u2_rx(wir_r, l)),
              u2_rx(wir_r, m));
  ...
  _jam_in(u2_wire wir_r,
          ...
          u2_noun l)                                              //  retain
  {
    u2_noun c = j2_mcc(Pit, by, get)(wir_r, m, a);
    u2_noun x;

    if ( u2_nul == c ) {
      m = j2_mcc(Pit, by, put)(wir_r, m, a, b);
...
*/
  u2_ho_jet 
  j2_mbj(Pit, jam)[] = {
    { ".3", c3__hevy, j2_mb(Pit, jam), Tier3, u2_none, u2_none },
    { }
  };
