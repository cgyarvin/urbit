...
*/
  ...
  u2_noun                                                         //  transfer
  j2_mcx(Pit, vane, fish)(u2_wire wir_r, 
                          u2_noun van,                            //  retain
                          u2_noun sut,                            //  retain
                          u2_atom axe)                            //  retain
  {
...
*/
                         ...
                         u2_noun cor)                             //  retain
  {
         ...
         (u2_none == (sut = u2_frag(u2_cv_sam, van))) )
    {
      ...
      return j2_mcx(Pit, vane, fish)(wir_r, van, sut, axe);
    }
  }

  u2_weak                                                         //  transfer
  j2_mci(Pit, vane, fish)(u2_wire wir_r,
                          u2_noun van,                            //  retain
                          u2_noun sut,                            //  retain 
                          u2_noun axe)                            //  retain
  {
    ...
    if ( u2_none == hoc ) {
      ...
      if ( (u2_none == j2_mcj(Pit, vane, fish)[0].xip) ) {
        u2_noun xip = u2_sh_find(wir_r, cor);
     
        c3_assert(u2_none != xip);
        j2_mcj(Pit, vane, fish)[0].xip = xip;
      }
  ...
  j2_mcy(Pit, vane, fish)(u2_wire wir_r,
                          ...
                          u2_noun axe)                            //  retain
  {
    u2_ho_jet *jet_j = &j2_mcj(Pit, vane, fish)[0];
    ...
    switch ( jet_j->sat_s ) {
      ...
      case u2_jet_dead: {
        ...
        cor = j2_mci(Pit, vane, fish)(wir_r, van, sut, axe);
        ...
        */
        {
          jet_j->sat_s = u2_jet_live;
          {
            ...
            if ( u2_bl_set(wir_r) ) {
              ...
              had = j2_mcx(Pit, vane, fish)(wir_r, van, sut, axe);
              u2_bl_done(wir_r, jub_r);
            }
          }
...
*/
  u2_ho_jet 
  j2_mcj(Pit, vane, fish)[] = {
    { ".3", c3__hevy, j2_mc(Pit, vane, fish), SafeTier6_b, u2_none, u2_none },
    { }
  };
