...
*/
           ...
           u2_atom axe)                                           //  retain
  {
    ...
    if ( u2_nul == peh ) {
      u2_noun lof = j2_mcy(Pit, ut, mint)(wir_r, van, boz, c3__noun, rix);
      ...
      if ( u2_yes == u2_stud(i_peh) ) {
        ...
        u2_as_trel(wer, &p_wer, 0, &r_wer);
        {
          ...
          u2_noun typ   = j2_mcy(Pit, ut, heal)
...
*/
                       ...
                       u2_noun cor)                               //  retain
  {
         ...
         (u2_none == (sut = u2_frag(u2_cv_sam, van))) )
    {
      ...
      return j2_mcx(Pit, ut, tuck)(wir_r, van, sut, hep, boz, rix);
    }
  }
        ...
        */
        {
          jet_j->sat_s = u2_jet_live;
          {
            ...
            if ( u2_bl_set(wir_r) ) {
              ...
              had = j2_mcx(Pit, ut, tuck)(wir_r, van, sut, hep, boz, rix);
              u2_bl_done(wir_r, jub_r);
            }
          }
