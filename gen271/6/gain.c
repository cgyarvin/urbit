...
*/
  u2_noun
  j2_mcx(Pit, vane, gain)(u2_wire, u2_noun, u2_noun, u2_noun);
             ...
             u2_noun p_gen)
  {
    if ( u2_nul == p_gen ) {
      ...
      u2_noun lev = j2_mcx(Pit, vane, gain)(wir_r, van, sut, ip_gen);
  ...
  u2_noun                                                         //  transfer
  j2_mcx(Pit, vane, gain)(u2_wire wir_r, 
                          u2_noun van,                            //  retain
                          u2_noun sut,                            //  retain
                          u2_noun gen)                            //  retain
  {
    ...
    if ( u2_no == u2_dust(gen) ) { 
      ...
      case c3__ktvd: {
        if ( u2_none == (q_gen = u2_frag(6, gen)) ) {
          ...
          return j2_mcx(Pit, vane, gain)(wir_r, van, sut, q_gen);
        }
      }
      case c3__csbn: {
...
*/
                         ...
                         u2_noun cor)                             //  retain
  {
         ...
         (u2_none == (sut = u2_frag(u2_cv_sam, van))) )
    {
      ...
      return j2_mcx(Pit, vane, gain)(wir_r, van, sut, gen);
    }
  }

  u2_weak                                                         //  transfer
  j2_mci(Pit, vane, gain)(u2_wire wir_r,
                          u2_noun van,                            //  retain
                          u2_noun sut,                            //  retain 
                          u2_noun gen)                            //  retain
  {
    ...
    if ( u2_none == hoc ) {
      ...
      if ( (u2_none == j2_mcj(Pit, vane, gain)[0].xip) ) {
        u2_noun xip = u2_sh_find(wir_r, cor);
     
        c3_assert(u2_none != xip);
        j2_mcj(Pit, vane, gain)[0].xip = xip;
      }
  ...
  j2_mcy(Pit, vane, gain)(u2_wire wir_r,
                          ...
                          u2_noun gen)                            //  retain
  {
    u2_ho_jet *jet_j = &j2_mcj(Pit, vane, gain)[0];
    ...
    switch ( jet_j->sat_s ) {
      ...
      case u2_jet_dead: {
        ...
        cor = j2_mci(Pit, vane, gain)(wir_r, van, sut, gen);
        ...
        */
        {
          jet_j->sat_s = u2_jet_live;
          {
            ...
            if ( u2_bl_set(wir_r) ) {
              ...
              had = j2_mcx(Pit, vane, gain)(wir_r, van, sut, gen);
              u2_bl_done(wir_r, jub_r);
            }
          }
...
*/
  u2_ho_jet 
  j2_mcj(Pit, vane, gain)[] = {
    { ".3", c3__hevy, j2_mc(Pit, vane, gain), SafeTier6_b, u2_none, u2_none },
    { }
  };
