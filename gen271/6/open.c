...
*/
  ...
  static u2_noun _open_mast_fix(u2_wire, u2_noun);
             ...
             u2_noun gen)
  {
    ...
    else if ( u2_yes == u2_as_pq(gen, c3__dtsg, &p_gen, &q_gen) ) {
  ...
  _open_do_pqr(sksg)  //  ?~
  {
    return u2_bt
      (wir_r,
       ...
       u2_bt
        (wir_r,
         u2_bc(wir_r, u2_bc(wir_r, c3__htsg, u2_nul), u2_rx(wir_r, q_gen)),
