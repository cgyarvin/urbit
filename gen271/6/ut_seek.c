...
*/
                        ...
                        u2_noun rep)                              //  retain
  {
    if ( u2_nul == rep ) {
      ...
      u2_noun vag = j2_mcx(Pit, ut, seek)(wir_r, van, sut, t_rep);
        ...
        if ( (u2_nul != hi_rep) || (u2_no == u2_stud(pi_rep)) ) {
          ...
          pro = u2_bt
            (wir_r, j2_mbc(Pit, peg)(wir_r, p_vag, pi_rep),
                    u2_nul,
                    j2_mcy(Pit, ut, peek)(wir_r, van, r_vag, pi_rep));
...
*/
                       ...
                       u2_noun cor)                               //  retain
  {
         ...
         (u2_none == (sut = u2_frag(u2_cv_sam, van))) )
    {
      ...
      return j2_mcx(Pit, ut, seek)(wir_r, van, sut, rep);
    }
  }
                        ...
                        u2_noun rep)                              //  retain
  {
    ...
    switch ( jet_j->sat_s ) {
      ...
      case u2_jet_dead: {
        ...
        cor = j2_mci(Pit, ut, seek)(wir_r, van, sut, rep);
        ...
        */
        {
          jet_j->sat_s = u2_jet_live;
          {
            ...
            if ( u2_bl_set(wir_r) ) {
              ...
              had = j2_mcx(Pit, ut, seek)(wir_r, van, sut, rep);
              u2_bl_done(wir_r, jub_r);
            }
          }
