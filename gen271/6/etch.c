...
*/
  static u2_noun
  _etch_per(u2_wire, u2_noun, u2_noun, u2_noun, u2_noun);

  static u2_noun
  _etch_term(u2_wire, u2_noun, u2_noun, u2_atom, u2_noun);

  static u2_noun
  _etch_term(u2_wire wir_r,
             u2_noun van,
             u2_noun sut,
             u2_atom p_wer,
             u2_noun giv)
      ...
      case c3__cell: {
        if ( (u2_no == u2_as_trel(sut, 0, &p_sut, &q_sut)) ) {
          ...
          if ( _1 == p_wer ) {
            ...
            if ( _2 == tip ) {
              pro = u2_bt
                (wir_r, c3__cell, _etch_term(wir_r, van, p_sut, tap, giv), 
                                  u2_bx(wir_r, q_sut));
            }
            else {
              pro = u2_bt
                (wir_r, c3__cell, u2_bx(wir_r, p_sut),
                                  _etch_term(wir_r, van, q_sut, tap, giv));
            }
      ...
      case c3__core: {
        if ( u2_no == u2_as_qual(sut, 0, &p_sut, &q_sut, &r_sut) ) {
          ...
          if ( _1 == p_wer ) {
            ...
            if ( _2 == tip ) {
              u2_noun gac = _etch_term(wir_r, van, p_sut, tap, giv);
              u2_noun huq;
