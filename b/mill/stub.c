...
/* _stub_peft_in(): convert peft items to sard list.
*/
u4_noun
           ...
           u4_skel kel)
{
  ...
  if ( u4_b_p(kel, u4_atom_chob, &p_kel) ) {
    ...
    return u4_k_qual(lane, u4_atom_flec, u4_atom_gant, hep, u4_noun_0);
  }
    ...
    return u4_k_cell(lane, u4_atom_pril, hin); 
  } 
    ...
    return u4_k_cell(lane, u4_atom_sard, _stub_peft_in(m, wix));
  }
