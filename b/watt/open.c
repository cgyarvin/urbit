  ...
  if ( u4_b_pq(gen, u4_atom_cast, &p_gen, &q_gen) ) {
    return u4_kt
      (lan,
       ...
       u4_kc(lan, u4_atom_lome, _open_mast_fix(p, p_gen, u4_axis_4)));
  }
    ...
    if ( !u4_n_eq(gen, bog) ) {
      ...
      return u4_kt
        (lan,
         ...
         u4_kc(lan, u4_atom_lome, _open_mast_fix(p, gen, u4_axis_4)));
    }
  }
}
...
_open_do_p(bean)
{
  ...
  _open_do_p(mong)
  {
    ...
    if ( u4_n_zero(tp_gen) ) {
      ...
      if ( u4_n_eq(tp_gen, u4_kc(lan, u4_atom_frag, u4_axis_4)) ) {
        return u4_trip;
      }
      return u4_kt
        (lan, u4_atom_gant,
  ...
  _open_do_pq(gnam)
  {
    ...
    return u4_kt
      (lan, u4_atom_mong, q_gen, u4_kc(lan, p_gen, u4_nul));
  }
