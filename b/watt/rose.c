  ...
  if ( !u4_b_pq(sub, u4_atom_core, &p_sub, &q_sub) ) {
    ...
    if ( u4_b_p(q_sub, u4_atom_hard, &pq_sub) ) {
      ...
      if ( u4_bag_in(sub, p->ver) ) {
        ...
        u4_pool faz = u4_bag_add(lan, sub, p->ver);
        u4_pool ver;
        u4_flag dem;

        ver = p->ver;
        p->ver = faz;
        dem = _rose_fine_soft(p, sub, pq_sub, qq_sub);
           ...
           u4_list mut)
{
  ...
  tac = _lark_feed(p, sub, tac, mut);

  return _iris_burn(p, sub, u4_noun_0, u4_noun_1, u4_no, tac);
}
...
*/
                  ...
                  u4_gene gen)
  {
    ...
    else if ( u4_b_p(sub, u4_atom_sand, &p_gen) ) {
      ...
      (lan, 
       ...
       _iris_burn
        (p,
         ...
         u4_noun_1,
         u4_no,
         _lark_feed(p, sub, u4_noun_0, mut)),
       sub);
  }
u4_type
_rose_gain(u4_crow p,
           ...
           u4_gene gen)
{
  u4_rack zet = _rose_gain_hunt(p, sub, gen);
...
*/
                    ...
                    u4_list rem)
  {
    ...
    if ( u4_n_zero(rem) ) {
      ...
      u4_plan giz    = _rose_seek(p, sub, pi_rem);
               ...
               u4_rack dus)
  {
    ...
    if ( u4_n_zero(dus) ) {
      ...
      return u4_k_cell
        (lan,
         u4_k_cell(lan, u4_ch(i_dus), _rose_make(p, sub, u4_ct(i_dus))),
         t_dus);
    }
  }
u4_tool
           ...
           u4_gene gen)
{
  ...
  if ( u4_b_p(gen, u4_atom_bail, &p_gen) ) {
    ...
    return _rose_make_bake(p, _rose_play(p, sub, gen), p_gen);
  }
    ...
    if ( !u4_n_zero(u4_ch(u4_ct(lar))) ) {
      ...
      return _iris_fish(p, r_lar, u4_noun_0, p_lar);
    }
  }
    ...
    if ( u4_n_zero(q_lar) ) {
      ...
      return u4_k_trel
        (lan,
         u4_noun_3,
         _rose_make_boil(p, quq_lar, p_lar, rem),
...
_rose_orth(u4_crow p,
           ...
           u4_type ref)
{
  return _rose_orth_a(p, sub, ref, u4_noun_0);
}
...
*/
               ...
               u4_rack dus)
  {
    ...
    if ( u4_n_zero(dus) ) {
      ...
      return u4_k_cell
        (lan,
         u4_k_cell(lan, u4_ch(i_dus), _rose_play(p, sub, u4_ct(i_dus))),
         t_dus);
    }
  }
u4_type
           ...
           u4_plot mut)
{
  ...
  _iris_burn(p, tac, u4_noun_0, u4_noun_1, u4_yes, mut);
  return u4_yes;
}
...
*/
  ...
  _rose_show_nest(u4_crow p,
                  ...
                  u4_type bon)
  {
    if ( !u4_so(_iris_nest(p, u4_atom_atom, u4_noun_0, u4_noun_1, bon)) ) {
      return _crow_fail(p, "nest: bump");
    }
    else return u4_yes;
  }
u4_flag
           ...
           u4_gene gen)
{
  ...
  if ( u4_b_p(gen, u4_atom_bail, &p_gen) ) {
    ...
    u4_type deg = _rose_play(p, sub, p_gen);
    u4_type bon = _rose_play(p, sub, q_gen);

    return _rose_show_nest(p, deg, bon);
  }
  else if ( u4_b_pq(gen, u4_atom_cell, &p_gen, &q_gen) ) {
    ...
    return _rose_show(p, sub, _crow_open(p, gen)); 
  }
}
