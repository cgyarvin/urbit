        ...
        (lan, u4_atom_core, 
              ...
              u4_k_trel
                (lan,
                 u4_atom_soft,
                 sut,
                 _gull_fill(p, u4_kc(lan, u4_atom_none, u4_nul), q_gen)));
    }
    else if ( u4_b_pq(gen, u4_atom_plin, &p_gen, &q_gen) ) {
      return u4_k_trel
        (lan,
