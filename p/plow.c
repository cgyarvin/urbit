...
#define _open_do_pqrs(stem)  \
  ...
  */
  ...
  _open_do_pq(bndr)
  {
    ...
    return u2_bt(wir_r, c3__bnrd, q_gen, p_gen);
  }
  ...
  _open_do_pq(htdr)
  {
    return 
      u2_bt
        (wir_r, c3__bndr,
                u2_bt(wir_r, c3__htrd, p_gen, u2_bc(wir_r, c3__frag, _1)),
                q_gen);
  }
...
****/
  ...
  */
                    ...
                    u2_gene gen)
    {
      ...
      else if ( u2_yes == u2_as_pq(gen, c3__bnrd, &p_gen, &q_gen) ) {
        return _lily_comb
          (wir_r,
           _rose_make(wir_r, sut, p_gen),
