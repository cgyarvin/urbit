...
*/
          ...
          u2_noun m)                                              //  retain
  {
    ...
    if ( _0 == j2_mbc(Pit, cut)(wir_r, 0, b, 1, a) ) {
      u2_noun x = j2_mbc(Pit, inc)(wir_r, b);
      u2_noun c = j2_mby(Pit, rub)(wir_r, x, a);

      p = j2_mbc(Pit, inc)(wir_r, u2_h(c));
      q = u2_rx(wir_r, u2_t(c));
      r = j2_mcc(Pit, by, put)(wir_r, m, b, u2_t(c));

      u2_rz(wir_r, c);
      u2_rz(wir_r, x);
    }
    else {
      u2_noun c = j2_mbc(Pit, add)(wir_r, _2, b);
      u2_noun l = j2_mbc(Pit, inc)(wir_r, b);

      if ( _0 == j2_mbc(Pit, cut)(wir_r, 0, l, 1, a) ) {
        u2_noun u, v, w;
        u2_noun x, y;

        u = _cue_in(wir_r, a, c, m);
        x = j2_mbc(Pit, add)(wir_r, u2_h(u), c);
        ...
        u2_noun d = j2_mby(Pit, rub)(wir_r, c, a);
        u2_noun x = j2_mcc(Pit, by, get)(wir_r, m, u2_t(d));
