           ...
           u2_noun gen)
  {
...
#if 0
    j2_mcy(Pt6, ut, dupt)(wir_r, van, "play: sut", sut);
    ...
    if ( u2_no == u2_dust(gen) ) {
      ...
      case c3__mtbn: u2_bi_cell(wir_r, u2_t(gen), &p_gen, &q_gen);
      {
        ...
        {
          u2_noun wix = j2_mcy(Pt6, ut, edit)
          ...
          if ( u2_nul == q_lar ) {
            ...
            u2_noun ret = j2_mcy(Pt6, ut, fire)
      ...
      case c3__pmdt: p_gen = u2_t(gen);
      {
        ...
        u2_noun ret = j2_mby(Pt6, core)(wir_r, sut, con);
