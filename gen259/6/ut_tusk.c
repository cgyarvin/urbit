...
*/
  u2_noun                                                         //  transfer
  j2_mcx(Pt6, ut, tusk)(u2_wire wir_r, 
                        u2_noun van,                              //  retain
                        u2_noun sut,                              //  retain
                        u2_noun hep,                              //  retain
                        u2_noun boz,                              //  retain
...
*/
  ...
  u2_weak                                                         //  transfer
  j2_mci(Pt6, ut, tusk)(u2_wire wir_r,
                        u2_noun van,                              //  retain
                        u2_noun sut,                              //  retain
                        u2_noun hep,                              //  retain
                        u2_noun boz,                              //  retain
  ...
  j2_mcy(Pt6, ut, tusk)(u2_wire wir_r,
                        ...
                        u2_noun rix)                              //  retain
  {
    u2_ho_jet *jet_j = &j2_mcj(Pt6, ut, tusk)[0];
    ...
    if ( jet_j->sat_s == u2_jet_live ) {
      ...
      cor = j2_mci(Pt6, ut, tusk)(wir_r, van, sut, hep, boz, rix);
      fol = u2_t(cor);
...
*/
  u2_ho_jet 
  j2_mcj(Pt6, ut, tusk)[] = {
    { ".3", c3__hevy, j2_mc(Pt6, ut, tusk), Tier6_b, u2_none, u2_none },
    { }
  };
