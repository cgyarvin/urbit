...
::    But mostly, functional system software.  The Hoon kernel
::    includes a simple functional OS, Arvo, about which nothing
::    whatsoever is known.
::
::::::  ::::::::::::::::::::::::::::::::::::::::::::::::::::::
::::::  ::::::    Preface                               ::::::
...
=>
  ...
  ++  fu                                                ::  modulo (mul p q)
    |=  a=[p=@ q=@]
    =+  b=?:(=([0 0] a) 0 (~(inv fo p.a) (~(sit fo p.a) q.a)))  ::  XX burnhaq
    |%
    ++  dif
      |=  [c=[@ @] d=[@ @]]
